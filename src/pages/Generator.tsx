  ...
  return (
    <div className="min-h-screen bg-[#F7F0E6] flex items-center justify-center p-4 selection:bg-primary/20">
      <div className="w-full max-w-md animate-fade-up">
        ...
        {/* --- CARD --- */}
        <div className="bg-white/80 backdrop-blur-md p-8 rounded-[2.5rem] shadow-card border border-primary/10 space-y-6">
          {/* Input Area */}
          ...
          <div className="flex gap-3 pt-2">
            <button 
              onClick={handleCopy}
              className="flex-1 bg-primary text-white py-4 rounded-full font-bold text-[10px] uppercase tracking-[0.2em] flex items-center justify-center gap-2 hover:opacity-90 transition-all shadow-lg active:scale-95"
            >
